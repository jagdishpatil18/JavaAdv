...
function validateemp()
{
	...
	var name = /^[a-zA-Z  ]+$/;
 	...
 	var esall=document.getElementById('sal').value;
 /* 	if($('#sal').val()>1000 || $('#sal').val()<1) */
 	if(esall>1000 || esall<1)
 	{
...
<div class="col-lg-4 col-md-6 col-sm-8" id="empre">
  ...
  <h2> Employee Registration</h2>
    <div class="form-group">
      ...
      <input type="text" id="ename" placeholder="Enter  name" name="name" >
    </div>
    
    <div class="form-group">
      <label id="addid" >Address</label>
       <textarea  rows="3" id="eadd"  placeholder="Enter Address" name="address"    style="margin-left:50px"></textarea>
    </div>
    
    <div class="form-group">
      <label  >Company Name</label>
     <input type="text" id="cname" placeholder="Enter company name" name="company"  >
    </div>
     <div class="form-group">
      <label >Age</label>
      <input type="number" id="num"placeholder="Enter Age" name="age" style="margin-left:80px">
    </div>
    <div class="form-group">
      <label >Salary</label>
      <input type="number" id="sal"placeholder="Enter Salary" name="salary"  style="margin-left:65px">
    </div>
    <div class="form-group">
      <label >Gender</label>
    ...
    <div class="form-group">
      ...
      <input type="checkbox" name="language" value="English" checked>English &nbsp &nbsp
