    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="UpdateDetails" method="post">
          ...
          <input type="submit" value="Update" id="id">
          <!-- <button  class="btn btn-info btn-md" id="id" formaction="UpdateDetails" method="post" >Update</button>-->
            <button  class="btn btn-info btn-md" id="id" formaction="Delete_Emp" method="post">Delete</button>
        </form>
        </div>
      </div>
