...
function validateemp()
{
	...
	var name = /^[a-zA-Z  ]+$/;
 	...
 	/* var lng=document.getElementById('languageU').value;
 	if(lng.length==null ||!name.test(lng))
 	{
...
<div class="col-lg-4 col-md-6 col-sm-8" id="empup">
<h2>  Update EmployeeDetails </h2>
  <form action="Update_Emp"method="post" onsubmit="return validateemp()"  name="empupdtn">
    ...
    <div class="form-group">
     ...
     <input type="text" id="specializeU" placeholder="Enter specialization" name="special" value="<%=rs.getString(6)%>" style="margin-left:30px"  >
    </div>
    <div class="form-group">
